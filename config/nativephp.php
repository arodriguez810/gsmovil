...
return [
    ...
    */
    ...
    // Cambiar en .env: NATIVEPHP_APP_VERSION=1.0.0
    ...
    */
    ...
    // Incrementar en .env: NATIVEPHP_APP_VERSION_CODE=2  (cada vez que publiques)
    ...
    */
    ...
    // Cambiar en .env: NATIVEPHP_APP_ID=com.tuempresa.tunombreapp
    ...
    */
    ...
    |
    */
    // Cambiar en .env: NATIVEPHP_DEVELOPMENT_TEAM=ABCDE12345
    // (Lo encuentras en developer.apple.com → Account → Membership Details)
    ...
    */
    ...
    'android' => [
        ...
        */
        'build' => [
                // Para producción (Play Store): cambiar a true en .env
    ...
    */
     ...
     * 1. Crear la API Key en: appstoreconnect.apple.com → Users and Access → Integrations
     * 2. Descargar el archivo .p8 y guardarlo en: storage/app/AuthKey_XXXXXXXXXX.p8
     * 3. Configurar en .env:
     *    APP_STORE_API_KEY=./storage/app/AuthKey_XXXXXXXXXX.p8
     *    APP_STORE_API_KEY_ID=XXXXXXXXXX
     *    APP_STORE_API_ISSUER_ID=xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx
     *    APP_STORE_APP_NAME="GS Movil"
     */
    'app_store_connect' => [
